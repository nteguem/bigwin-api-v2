...
// du trafic de test). Monté uniquement si ENABLE_DEV_ACCESS_TOOLS=true → absent
// (404) en prod. POST /api/dev/access/simulate-reward  { nonce }
if (process.env.ENABLE_DEV_ACCESS_TOOLS === 'true') {
