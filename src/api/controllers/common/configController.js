/**
 * @fileoverview Controller de gestion de la configuration par pays (GLOBAL)
...
/**
 * @route PUT /api/admin/config/:countryCode
...
/**
 * @route DELETE /api/admin/config/:countryCode
...
/**
 * @route PATCH /api/admin/config/:countryCode/toggle
